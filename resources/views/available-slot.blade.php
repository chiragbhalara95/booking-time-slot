            ...
            <div class="col-md-4">
               ...
               <div class="input-group date" id="ava_mon_start" data-target-input="nearest">
                  <input type="text" class="form-control datetimepicker-input ava_mon_start-input" data-target="#ava_mon_start"
                     value="{{isset($slotsConfigData[1]['available_start_time']) ? $slotsConfigData[1]['available_start_time'] : ''}}">
            ...
            <div class="col-md-4">
               ...
               <div class="input-group date" id="ava_mon_end" data-target-input="nearest">
                  <input type="text" class="form-control datetimepicker-input ava_mon_end-input" data-target="#ava_mon_end"
                     value="{{isset($slotsConfigData[1]['available_end_time']) ? $slotsConfigData[1]['available_end_time'] : ''}}">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="input-group date" id="ava_tue_start" data-target-input="nearest">
                     <input type="text" class="form-control datetimepicker-input ava_tue_start-input" data-target="#ava_tue_start"value="{{isset($slotsConfigData[2]['available_start_time']) ? $slotsConfigData[2]['available_start_time'] : ''}}">
               ...
               <div class="col-md-4">
                  <div class="input-group date" id="ava_tue_end" data-target-input="nearest">
                     <input type="text" class="form-control datetimepicker-input ava_tue_end-input" data-target="#ava_tue_end"
                        value="{{isset($slotsConfigData[2]['available_end_time']) ? $slotsConfigData[2]['available_end_time'] : ''}}">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="input-group date" id="ava_wed_start" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input ava_wed_start-input" data-target="#ava_wed_start"value="{{isset($slotsConfigData[3]['available_start_time']) ? $slotsConfigData[3]['available_start_time'] : ''}}">
                  ...
                  <div class="col-md-4">
                     <div class="input-group date" id="ava_wed_end" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input ava_wed_end-input" data-target="#ava_wed_end" 
                           value="{{isset($slotsConfigData[3]['available_end_time']) ? $slotsConfigData[3]['available_end_time'] : ''}}">
               ...
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="input-group date" id="ava_thu_start" data-target-input="nearest">
                           <input type="text" class="form-control datetimepicker-input ava_thu_start-input" data-target="#ava_thu_start"value="{{isset($slotsConfigData[4]['available_start_time']) ? $slotsConfigData[4]['available_start_time'] : ''}}">
                     ...
                     <div class="col-md-4">
                        <div class="input-group date" id="ava_thu_end" data-target-input="nearest">
                           <input type="text" class="form-control datetimepicker-input ava_thu_end-input" data-target="#ava_thu_end"
                              value="{{isset($slotsConfigData[4]['available_end_time']) ? $slotsConfigData[4]['available_end_time'] : ''}}">
                  ...
                  <div class="form-group">
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="input-group date" id="ava_fri_start" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input ava_fri_start-input" data-target="#ava_fri_start"value="{{isset($slotsConfigData[5]['available_start_time']) ? $slotsConfigData[5]['available_start_time'] : ''}}">
                        ...
                        <div class="col-md-4">
                           <div class="input-group date" id="ava_fri_end" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input ava_fri_end-input" data-target="#ava_fri_end"
                                 value="{{isset($slotsConfigData[5]['available_end_time']) ? $slotsConfigData[5]['available_end_time'] : ''}}">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="input-group date" id="ava_sat_start" data-target-input="nearest">
                                 <input type="text" class="form-control datetimepicker-input ava_sat_start-input" data-target="#ava_sat_start"value="{{isset($slotsConfigData[6]['available_start_time']) ? $slotsConfigData[6]['available_start_time'] : ''}}">
                           ...
                           <div class="col-md-4">
                              <div class="input-group date" id="ava_sat_end" data-target-input="nearest">
                                 <input type="text" class="form-control datetimepicker-input ava_sat_end-input" data-target="#ava_sat_end" value="{{isset($slotsConfigData[6]['available_end_time']) ? $slotsConfigData[6]['available_end_time'] : ''}}">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="input-group date" id="ava_sun_start" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input ava_sun_start-input" data-target="#ava_sun_start"value="{{isset($slotsConfigData[7]['available_start_time']) ? $slotsConfigData[7]['available_start_time'] : ''}}">
                              ...
                              <div class="col-md-4">
                                 <div class="input-group date" id="ava_sun_end" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input ava_sun_end-input" data-target="#ava_sun_end" value="{{isset($slotsConfigData[7]['available_end_time']) ? $slotsConfigData[7]['available_end_time'] : ''}}">
                     ...
                     <div class="card-footer">
                        <button type="button" class="btn btn-primary save-available-slots">Save</button>
                     </div>
   </form>
   </div>
   <!-- /.card -->
